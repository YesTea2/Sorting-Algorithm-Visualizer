...
def CreateCenterFrame():
    ...
    centerFrame = ctk.CTkFrame(
        master=currentlyDisplayedMainFrame[0],
        width=1340,
        height=450,
        fg_color="#354F52",
        border_color="#84A98C",
...
def CreateRightSideMainButtonFrame():
    ...
    # Creating the frame
    frame = ctk.CTkFrame(
        master=currentlyDisplayedMainButtonFrame[0], width=300, fg_color="transparent"
    )
    # Packing to the screen
...
def CreateLeftSideMainButtonFrame():
    ...
    # Creating the frame
    frame = ctk.CTkFrame(
        master=currentlyDisplayedMainButtonFrame[0], width=250, fg_color="transparent"
    )
    # Packing to the screen
    frame.pack(side="left", padx=(200, 0))
    # Creating a label to sit at the top of the frame
    label = ctk.CTkLabel(
        master=frame, text="DATA SORTING", text_color="white", font=("Great Vibes", 30)
    )
    # Packing the label
    label.pack(side="top", pady=(0, 20))
    # Appending the newly created frame to the list that holds it for refrence
...
def CreateSortButtonFrameLeft():
    ...
    """
    # Creating the frame
    sortFrame = ctk.CTkFrame(
        master=currentlyDisplayedLeftSideMainButtonFrame[0],
        width=200,
...
def CreateSearchButtonFrame():
    ...
    # Create the frame
    searchFrame = ctk.CTkFrame(
        master=currentlyDisplayedRightSideMainButtonFrame[0],
        width=600,
        fg_color="transparent",
    )
    # Pack the frame
...
def CreateLeftSortButtons():
    ...
    bubbleSortButton = ctk.CTkButton(
        master=currentlyDisplayedSortButtonLeftFrame[0],
        width=125,
        height=65,
        text="BUBBLE",
        text_color="white",
        ...
        border_color="#84A98C",
        border_width=2,
        command=bttns.RunBubbleSort,
        fg_color="#52796F",
    )
    mergeSortButton = ctk.CTkButton(
        master=currentlyDisplayedSortButtonLeftFrame[0],
        width=125,
        height=65,
        text="MERGE",
...
def CreateRightSortButtons():
    ...
    selectionSortButton = ctk.CTkButton(
        master=currentlyDisplayedSortButtonRightFrame[0],
        width=125,
        height=65,
        text="SELECTION",
        text_color="white",
        ...
        border_color="#84A98C",
        border_width=2,
        command=bttns.RunSelectionSort,
        fg_color="#52796F",
    )
    resetButton = ctk.CTkButton(
        ...
        border_color="#84A98C",
        border_width=2,
        command=bttns.ResetWithNewData,
        fg_color="#52796F",
    )
    # Packing the buttons to the screen
...
def CreateSearchButtons():
    ...
    userInput = ctk.CTkEntry(
        master=currentlyDisplayedSearchButtonFrame[0],
        placeholder_text="Enter value to highlight",
        text_color="white",
        font=("Great Vibes", 15),
        width=200,
        height=50,
    ...
    userSearchButton = ctk.CTkButton(
        master=currentlyDisplayedSearchButtonFrame[0],
        width=125,
        height=65,
        text="SEARCH",
